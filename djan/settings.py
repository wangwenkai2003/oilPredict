...
SECRET_KEY = 'django-insecure-5emwzs1^m^gy@w571nae0n2cj*02#fga=h!kb&%j#=fe#7bg4-'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:7040",  # 将此替换为你实际的前端地址
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'pre/dist')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS=[
    os.path.join(BASE_DIR,'pre/dist/static')
]
